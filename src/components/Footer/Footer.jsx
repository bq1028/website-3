    ...
    render () {
            ...
            <div className = 'footer' id = 'contactUs'>
                 <Grid container >
                    <Grid item lg={4} sm={6} xs={12} className = 'footer--contacts'>
                        <ul>
                            <li>Address: Vanadzor, Shinararneri 12</li>
                            <li>Email: vanitinc@gmail.com</li>
                            <li>Phone: +374 77 999 999</li>
                        </ul>
                    </Grid>
      ...
      >
        <path d="M48.875 0C21.882 0 0 21.882 0 48.875S21.882 97.75 48.875 97.75 97.75 75.868 97.75 48.875 75.868 0 48.875 0zm18.646 24.89l-6.76.003c-5.301 0-6.326 2.519-6.326 6.215v8.15h12.641l-.006 12.765H54.436v32.758H41.251V52.023H30.229V39.258h11.022v-9.414c0-10.925 6.675-16.875 16.42-16.875l9.851.015V24.89h-.001z" />
                            ...
                            <li><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path  d="M243.196,0C108.891,0,0,108.891,0,243.196s108.891,243.196,243.196,243.196
			...
			C386.073,169.659,375.889,180.208,364.186,188.598z"/></svg></li>
                            <li><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M255.968,5.329C114.624,5.329,0,120.401,0,262.353c0,113.536,73.344,209.856,175.104,243.872
			...
			c0,6.88,4.608,14.88,17.6,12.352C438.72,472.145,512,375.857,512,262.353C512,120.401,397.376,5.329,255.968,5.329z"/></svg></li>
                        </ul>
